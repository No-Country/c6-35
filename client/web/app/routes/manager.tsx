...
function Menu() {
    ...
    return (<>
            <div className={"w-screen min-w-full sm:w-64 sm:min-w-[16rem] h-screen sticky bg-app-w-secodary left-0 top-0 flex-col border-r border-app-w-write-ash " + ((show)? "flex":"hidden")}>
                <button onClick={()=>{setShow(!show)}} className="h-8 w-8 bg-app-w-secodary absolute translate-y-5 right-0 mr-4 rounded-md sm:translate-y-24 sm:translate-x-8 flex justify-center items-center"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 18V16.5H21V18H3ZM3 12.75V11.25H21V12.75H3ZM3 7.5V6H21V7.5H3Z" fill="white"/></svg>
</button>
                ...
                <div className="bg-app-w-write h-full">
                    <nav className="sm:flex">
                        <ul className="w-full mt-8 text-app-w-write-ash translate-y-20 text-left">
                            <li className="h-12 flex justify-center items-center"><div><NavLink to="./job"  className={({ isActive }) =>isActive ? "text-app-w-primary" : undefined}>Trabajos</NavLink></div></li>
            ...
            <div className={"fixed sm:sticky z-50  w-screen sm:w-16 sm:min-w-[4rem] h-12 sm:h-screen bg-app-w-secodary left-0 top-0 border-r border-app-w-write-ash flex sm:flex-col " + ((show)? "hidden":"")}>
                <div className="w-24 h-12 sm:w-full bg-app-w-primary">
                    <button className="w-full h-full  flex justify-center items-center" onClick={()=>{setShow(!show)}}><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M3 18V16.5H21V18H3ZM3 12.75V11.25H21V12.75H3ZM3 7.5V6H21V7.5H3Z" fill="white"/></svg>
</button>
                </div>
                <div className="bg-app-w-secodary w-full h-full">
                    <div className="hidden sm:flex">
                        <ul className="w-full mt-8 text-app-w-primary-pale">
                            <li className="h-12 flex justify-center items-center"><Link to="./job"><img src={ijob} className="h-4 w-4"></img></Link></li>
